...
public class NoisetwoAct extends AppCompatActivity {

    TextView mStatusView,maxnoisss;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_noisetwo);
      ...
      //  maxnoisss = (TextView) findViewById(R.id.maxnoiss);
        ...
        if (runner == null)
        {
           ...
           handler.postDelayed(new Runnable() {
             ...
             @Override
                public void run() {
                    startActivity(new Intent(NoisetwoAct.this,Dynamictest.class));
                }
            },10000L);
