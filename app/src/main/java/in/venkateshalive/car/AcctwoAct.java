...
public class AcctwoAct extends Activity implements SensorEventListener {

    TextView contdis;

    public static float bx=-15.0f,maxx=-15.0f,ax=15.0f,minx=15.0f,by=-15.0f,maxy=-15.0f,ay=15.0f,miny=15.0f,bz=-15.0f,maxz=-15.0f,az=15.0f,minz=15.0f;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_acctwo);
        ...
        */
        ...
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
                startActivity(new Intent(AcctwoAct.this,NoisethreeAct.class));
            }
        },10000L);
